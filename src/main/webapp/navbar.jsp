...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(54,102,120,0.08);">
        <a class="navbar-brand" href="/" style="font-weight: bold;"><img src="https://mygluten-freekitchen.com/wp-content/uploads/wordpress-popular-posts/4079-featured-100x100.jpg" style="width: 100px; height: 100px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/addcookie">Add Cookie</a>
                </li>
                <li class="nav-item">
